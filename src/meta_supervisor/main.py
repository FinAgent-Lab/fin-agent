...
async def root():
    ...
    """
    return {"service": "Meta Supervisor", "version": "0.1.0", "status": "running"}
...
async def health_check():
    ...
    required_env_vars = [
        "OPENAI_API_KEY",
        "MARKET_ANALYSIS_API_BASE_URL",
        "TRADING_STRATEGY_API_BASE_URL",
    ]
    ...
    try:
        ...
        health_data["checks"]["market_analysis_service"] = {
            "status": "healthy",
            "available": True,
        }
